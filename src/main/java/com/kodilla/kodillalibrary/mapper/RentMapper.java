...
@Mapper(componentModel = "spring", uses = {StorageEntryMapper.class, ReaderMapper.class, LibraryStorageEntryService.class})
public interface RentMapper {
    ...
    List<Rent> mapToRentList(List<RentDto> rentDtoList);
    List<RentDto> mapFetchedRentDtoListToRentDtoList(List<FetchedRentDto> rentDtoList);
    List<RentDto> mapToRentDtoList(List<Rent> rentDtoList);
    List<FetchedRentDto> mapRentDtoToFetchedDtoList(List<RentDto> rentDtoList);
